...
public class CreateStaffPanel extends JPanel{
	...
	private static final long serialVersionUID = 1L;
		...
		private StaffPanelListener staffPanelListener;
		...
		public CreateStaffPanel(){
			...
			TitledBorder innerBorder = BorderFactory.createTitledBorder("Add Staff Member");
			...
			String desig[] ={"Select a Designation","Head","Director","Executive","Staff"};
			...
			String dept[] ={"Select a department","Accounts","VUES","Administration","HR"};
			...
			createButton.addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent e) {
					...
					// System.out.println(gender);
					 ...
					 StaffPanelEvent  spe = new StaffPanelEvent(this, firstName, lastName, fatherName, motherName, gender, dob, homeAddress, city, postalCode, country, entryDate, designation, id, department, status);
					 if(staffPanelListener != null){
						 staffPanelListener.staffPanelEventOccured(spe);
					 }
		...
		public void setStaffPanelListener(StaffPanelListener listener){
			staffPanelListener = listener;
		}
